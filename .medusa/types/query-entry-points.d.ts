...
export type DigitalProduct = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  product_variant_link: Maybe<LinkDigitalProductDigitalProductProductProductVariant>;
...
export type DigitalProductOrder = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  order_link: Maybe<LinkDigitalProductDigitalProductOrderOrderOrder>;
  order: Maybe<Order>;
};
...
export type LinkDigitalProductDigitalProductOrderOrderOrder = {
  __typename?: 'LinkDigitalProductDigitalProductOrderOrderOrder';
  digital_product_order_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  digital_product_order: Maybe<DigitalProduct>;
  order: Maybe<Order>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
  deletedAt: Maybe<Scalars['String']['output']>;
...
export type LinkDigitalProductDigitalProductProductProductVariant = {
  __typename?: 'LinkDigitalProductDigitalProductProductProductVariant';
  digital_product_id: Scalars['String']['output'];
